...
describe('CountryVatRate Debug', function () {
    ...
    it('can create a simple country VAT rate manually', function () {
        $vatRate = CountryVatRate::create([
            'country_code'  => 'ES',
            'country_name'  => 'Spain',
            'standard_rate' => cents(2100), // 21% in base 100
        ...
        expect($vatRate->standard_rate->unscaledValue())->toBe(2100);
    ...
    it('can create a country VAT rate with minimal data', function () {
        $vatRate = CountryVatRate::create([
            'country_code'  => 'FR',
            'country_name'  => 'France',
            'standard_rate' => cents(2000), // 20% in base 100
            'is_active'     => true,
            'data_source'   => 'manual',
            'last_updated'  => now(),
        ]);
        ...
        expect($vatRate->standard_rate->unscaledValue())->toBe(2000);
    ...
    it('can create a country VAT rate with empty arrays', function () {
        $vatRate = CountryVatRate::create([
            ...
            'standard_rate'     => cents(1900), // 19% in base 100
            'reduced_rates'     => [],
            'exempt_categories' => [],
            'is_active'         => true,
            'data_source'       => 'manual',
        ...
        expect($vatRate->standard_rate->unscaledValue())->toBe(1900);
        expect($vatRate->reduced_rates)->toBe([]);
