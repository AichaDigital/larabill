...
namespace AichaDigital\Larabill\Tests\Unit\Services;
...
class VatVerificationServiceApiFailureTest extends TestCase
{
    public function test_returns_error_when_all_apis_fail(): void
    {
    ...
    public function test_returns_error_when_primary_api_fails_but_fallback_succeeds(): void
    {
