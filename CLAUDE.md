...
- **Dependencias notables:** `lara-verifactu ^1.0` (estable), `lara-privacy-core ^1.0`, `lara100 ^2.0` (FixedDecimal — AID-237), `lararoi ^1.0` (puente fino de verificación VAT/NIF — AID-309), `dompdf/dompdf ^3.1`.
