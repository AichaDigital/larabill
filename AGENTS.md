...
Laravel 12 or 13, Pest. Framework-agnostic (no Filament coupling). AGPL-3.0-or-later.
...
2. `database/migrations/<name>.php.stub` — **dedicated**, **byte-identical to the `.php`** (a derived artifact: generated by `bin/sync-migration-stubs`, never edited by hand — see ADR-007), published to consumers by `larabill:install`.
